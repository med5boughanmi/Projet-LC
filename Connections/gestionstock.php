...
$hostname_gestionstock = "localhost";
$database_gestionstock = "company";
$username_gestionstock = "root";
$password_gestionstock = "root";
$gestionstock = mysql_pconnect($hostname_gestionstock, $username_gestionstock, $password_gestionstock) or trigger_error(error(),E_USER_ERROR); 
...
$bdd = new PDO_etendu("mysql:host=".$hostname_gestionstock."; dbname=".$database_gestionstock."", $username_gestionstock, $password_gestionstock);
