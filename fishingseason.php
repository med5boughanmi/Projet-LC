							...
							<div class="col-xs-12">
								...
								<div class="widget-box">
									<div class="widget-header widget-header-blue widget-header-flat">
										<h4 class="widget-title lighter">Fishing season</h4>
									</div>
											...
											<div id="fuelux-wizard-container">
												...
												<div class="step-content pos-rel">
													<div class="step-pane active" data-step="1">
														...
														<form class="form-horizontal" id="validation-form" name="formulaire_ajout" action="fishseason.php" method="POST">
															<div class="form-group">
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="season">Fishing season:</label>

																<div class="col-xs-12 col-sm-9">
																	<select id="season" name="season" class="select2" data-placeholder="Click to Choose...">
																		<option value="">choose season</option>
																		<option value="season1">8-9 </option>
																		<option value="season2">9-10</option>
																		<option value="season3">10-11</option>
																	</select>
																</div>
																</div>
																
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="season">Main catch:</label>
																<div class="col-xs-12 col-sm-9">
																	<select id="catch" name="season2" class="select2" data-placeholder="Click to Choose...">
																		<option value="">choose  type of fich</option>
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="price" name="price" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
																</div>
																	<div class="form-group">
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="season">Mostly used ingine:</label>

																<div class="col-xs-12 col-sm-9">
																	<select id="season" name="season3" class="select2" data-placeholder="Click to Choose...">
																		 
																		<option value="">choose  type of engine</option>
																...
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="season">Fishing implements:</label>
																<div class="col-xs-12 col-sm-9">
																	<select id="implement" name="implement" class="select2" data-placeholder="Click to Choose...">
																		<option value="">choose  type of Fishing implements:</option>
