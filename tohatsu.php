											...
											<div id="fuelux-wizard-container">
												...
												<div class="step-content pos-rel">
													<div class="step-pane active" data-step="1">
														...
														<form class="form-horizontal" id="validation-form" action="engines.php" method="POST">
															<div class="form-group">
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="number"> HP :</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="hp" name="hp" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="height"> Qte :</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="qte" name="qte" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
																...
																<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="weight"> Price:</label>
...
<!-- PAGE CONTENT ENDS -->
	...
	<input type="hidden" name="MM_insert_totatsu" value="formulaire_ajout_totatsu">		
		</div><!-- /.main-container -->
</form>
		<!-- basic scripts -->
