														...
														<form class="form-horizontal" id="validation-form"  method="POST" action="boats.php">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="name" name="nbfiber" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="name" name="hgfiber" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="name" name="wgfiber" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="name" name="lgfiber" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
...
<!-- PAGE CONTENT ENDS -->
      ...
      <input type="hidden" name="MM_insert_fb" value="formulaire_ajout_fb" />			
		</div><!-- /.main-container -->
</form>
		<!-- basic scripts -->
