												...
												<div class="step-content pos-rel">
													<div class="step-pane active" data-step="1">
														...
														<form class="form-horizontal" id="validation-form" method="get">
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name"> Engine dealer:</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="hp" name="name" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="adr">Adress :</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="adressdl" name="adressdl" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
																...
																<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="namepart"> Spare parts dealer:</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="spname" name="spname" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="adrsp">Adress :</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" id="adresssp" name="adresssp" class="col-xs-12 col-sm-5" />
																	</div>
																</div>
															</div>
															</div>
